...
export class CompensationHistoryComponent implements OnInit {
  ...
  ngOnInit() {
    this.compensations = [
      ...
      { id: '132', numberOfHours: -4, startDate: '2018-12-03', endDate: '2018-12-03', status: 'Pending' , description: 'Urgent INC474637'},
      ...
      { id: '345', numberOfHours: 4, startDate: '2018-11-15', endDate: '2018-11-15', status: 'Approved', description: ''},
    ];
  }
